...
namespace RestaurantPos.Api.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        {
            // 1. Calculate Total Amount server-side for security/accuracy
            decimal totalAmount = 0;
            foreach (var item in input.Items)
            {
                decimal itemTotal = item.Price * item.Quantity; // Base price * Qty
            ...
            var orderNumber = DateTime.Now.ToString("yyyyMMddHHmmss"); // Simple order number generator
